...
public class DeletionSwipeHelperInfo extends ItemTouchHelper.SimpleCallback
{
	...
	public DeletionSwipeHelperInfo(int dragDirs, int swipeDirs, Context context, OnSwipeListener listener)
	{
        ...
        deleteColor = ContextCompat.getColor(context, R.color.background_info_swipe);
	...
	public void onChildDraw(Canvas canvas, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive)
	{
		...
		deleteIcon = ContextCompat.getDrawable(context, R.drawable.info);
