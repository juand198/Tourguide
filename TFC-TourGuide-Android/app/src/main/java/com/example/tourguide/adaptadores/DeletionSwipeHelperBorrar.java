...
public class DeletionSwipeHelperBorrar extends ItemTouchHelper.SimpleCallback
{
	...
	public DeletionSwipeHelperBorrar(int dragDirs, int swipeDirs, Context context, OnSwipeListener listener)
	{
